...
export default function WorkPage() {
  return (
    <>
      ...
      <section
        id='design-day'
        className='scroll-mt-24 md:scroll-mt-28 bg-white dark:bg-desert-900 py-12 md:py-16'
      >
        <div className='container mx-auto px-4'>
            ...
            <div className='grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start'>
              <div className='text-center lg:text-left'>
                <p className='font-first-rodeo text-sm uppercase tracking-[0.2em] text-brand-sage mb-3'>
                  Our most approachable offering
                </p>
                ...
                <p className='text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6'>
                  For those of you who have a list of website tasks that keep
                  getting pushed down the road. We spend one focused day getting
                  those lingering updates over the finish line. Stop putting
                  things off until "next week."
                </p>
