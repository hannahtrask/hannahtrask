      ...
      <div className="pt-24">
        ...
        <div className="relative h-[50vh] w-full flex items-center">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <Link href="/" className="inline-flex items-center text-white hover:text-gray-200 mb-4 text-sm tracking-wide">
              <ArrowLeft className="mr-2 h-4 w-4" />
              Back to all projects
            </Link>
            <h1 className="text-4xl md:text-5xl font-light text-white drop-shadow-md">{project.title}</h1>
          </div>
        </div>
