        ...
        <>
            ...
            <div className="relative h-screen w-full flex items-center">
                <div className="absolute inset-0 z-0">
                    <Image src="/mountain-backdrop.jpg" alt="Mountain landscape" fill priority className="object-cover" />
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-2xl">
                        <h1 className="text-5xl md:text-6xl font-light mb-6 tracking-tight text-white drop-shadow-md">
                            Crafting <span className="font-normal italic">digital</span> adventures
                        </h1>
                        <p className="text-xl text-gray-100 leading-relaxed mb-8 drop-shadow-md">
                            Transforming ideas into exceptional web experiences with the same passion I bring to exploring the
                            outdoors.
                        </p>
                        <Link
                            href="#projects"
