                ...
                <div className='container mx-auto px-4'>
                    <div className='max-w-4xl mx-auto text-center'>
                        ...
                        <p className='text-sm leading-relaxed text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mt-6'>
                            Your website is often where
                            you make your first impression and where customers decide whether
                            or not they are going to work with you. Our work blends strategy,
                            design, and development so your site can support real growth
                            without feeling complicated.
                        </p>
                        <p className='text-sm leading-relaxed text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mt-6'>
                            We&apos;ll help you build an online presence that feels like a natural
                            extension of your business and your values.
                        </p>
                    </div>
                </div>
            </div>
