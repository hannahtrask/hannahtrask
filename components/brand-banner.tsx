...
export default function BrandBanner() {
  ...
  const repeatedText = bannerText.repeat(2)

  return (
    <div className='relative py-4 w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] h-32 bg-rose-700 dark:bg-rose-800 overflow-hidden'>
