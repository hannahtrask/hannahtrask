    ...
    <div className='min-w-0 overflow-hidden rounded-xl border border-desert-200 bg-desert-50/60 p-6 dark:border-desert-700 dark:bg-desert-900/40'>
      ...
      <div className='mt-5 flex justify-center lg:justify-start'>
        <a
          ...
          className='inline-flex items-center justify-center gap-2 rounded-none bg-brand-sage px-4 py-2 text-sm text-white hover:opacity-90'
        >
    ...
    >
      <div className='max-w-8xl mx-auto'>
        <div className='grid min-w-0 grid-cols-1 gap-8 lg:grid-cols-2'>
          <BookingCard
            title="We're not sure what we want, can we chat?"
          ...
          <BookingCard
            title='We need a website and we know what we want'
