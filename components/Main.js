    ...
    return (
      <div id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p><strong>Vert Solutions</strong> is a team of dedicated ski resort experts who have a vision for the future of how the ski industry handles booking, scheduling, and guest management. Vert Solutions works with clients year-round to <strong>design, build, and implement</strong> Vert Solutions software. Our team works together united under a shared love of the winter sports industry. We develop within the <strong>agile</strong> framework and use <strong>Trello</strong>, <strong>Microsoft Teams</strong>, and <strong>Slack</strong> for team coordination.</p>
          <p>As one of two developers for Vert Solutions, I manage and implement bug fixes and code updates for upwards of five major ski resorts including Aspen Snowmass and Big Sky. We release incrementally and regularly maintain contact with our clients.</p>
          <p>I travel to our various client's locations to attend conferences and conduct training sessions on our software. Right now, I am <strong>integrating our platform for one of our new clients</strong>.</p>
          <p>Visit Vert Solutions' website <a href="https://www.vertsolutions.com/" target="_blank"><strong>here</strong></a>.</p>
          {close}
        </article>

        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          <h2 className="major">Writing</h2>
          <p>I received a Bachelor's degree in English from the <strong>University of Vermont</strong> in 2015 and am currently a freelance writer for the Jackson Hole News & Guide.<br /><br />As someone who has always appreciated the nuances of words, I find myself writing for fun often. Find my creative writing <a href="https://medium.com/@hannahtrask"><strong>Medium page here</strong></a> and check out a couple opinion pieces I have written for the Jackson Hole News and Guide <a href="https://www.jhnewsandguide.com/opinion/guest_shot/anger-bubbles-up-but-kindness-is-a-radical-act/article_880f4be1-f0dd-5044-a21c-84fe1cd5383f.html" target="_blank"><strong>here</strong></a>, <a href="https://www.jhnewsandguide.com/opinion/guest_shot/jackson-hole-restaurant-pro-i-am-a-server-not-a-servant/article_b45bc7a5-e3d7-5db4-9863-0f0caaa82b66.html" target="_blank"><strong>here</strong></a>. Also check out this article I wrote for the Arts & Entertainment section <a href="https://www.jhnewsandguide.com/scene/music/local/cowboy-gets-u-foric-for-a-week/article_3291c375-38a3-5bba-b0ef-366cc285ef11.html" target="_blank"><strong>here</strong>.</a></p>
          <p>As a seasoned writer, I have found that <strong>empathy</strong> and <strong>storytelling</strong> are key ingredients to creating content for the client. If you're looking for high quality work quickly, I'm your gal. As a lifelong reader and writer I can competently create short blurbs and longer form essay-style text. My skillset includes but isn't limited to <strong>MLA, Chicago Style</strong>, <strong>social media posts</strong>, and <strong>event advertisements and descriptions</strong>.</p>
