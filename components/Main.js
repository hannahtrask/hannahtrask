    ...
    return (
      <div id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p><strong>Bikology</strong> is a team of dedicated bike experts who have a vision for the future of how the bike industry handles custom bike building and retail. Bikology provides an <strong>end-to-end service</strong> for cyclists to <strong>design, build, and purchase</strong> what they view as their ideal bicycle through an on-demand visual bike builder. The flagship product is an on-demand visual bike building software. This software demands a wide breadth of knowledge and willingness to learn— from trigonometry to bike part compatibility logic. Our team works together united under a shared love of epic mountain biking and single track trails.</p>
