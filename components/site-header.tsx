        ...
        <header className="relative z-20 w-full">
            <div className="mx-auto max-w-7xl px-4 pt-4 sm:px-6 lg:px-8">
                <div className="relative flex flex-col items-center gap-4 pt-2 md:pt-0">
                    ...
                    <Link href="/" className="flex items-center justify-center" aria-label="Sagebrush Web Studio home">
                        <Image
                            src="/site-title/SagebrushSecondaryLogo-07.png"
                            alt="Sagebrush Web Studio secondary logo"
                            width={240}
                            height={112}
                            className="h-auto w-[clamp(9.5rem,30vw,15rem)] object-contain sm:w-[clamp(10rem,26vw,15rem)] lg:w-[12.75rem]"
                            priority
                        />
                    </Link>
