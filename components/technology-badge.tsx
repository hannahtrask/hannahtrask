...
export default function TechnologyBadge({
  ...
  const variantClasses = {
    ...
    primary: 'bg-white/25 backdrop-blur-md text-white border border-white/40 shadow-lg',
    overlay: 'bg-black/30 backdrop-blur-md text-white border border-white/30 shadow-lg'
  }
