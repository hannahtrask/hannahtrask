...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    ...
    >
      <div ref={cardRef} className="relative h-[70vh] overflow-hidden bg-white shadow-lg group cursor-pointer">
...
function ParallaxCategorySection({ category, categoryProjects }: { 
  ...
  return (
    <section id='projects' className='py-20 bg-[#f8f7f4]'>
      <div className='container mx-auto px-4'>
        ...
        >
          <h2 className='text-5xl md:text-6xl font-playfair font-light mb-8 tracking-wide text-[#2d3c35]'>
            Featured Work
          </h2>
