...
export const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    fullDescription: 'A comprehensive e-commerce platform built from the ground up with custom product configuration tools, advanced inventory management, and a streamlined checkout process. The platform includes admin dashboards, customer accounts, and integrated payment processing.',
  ...
  },
  {
    ...
    fullDescription: 'A stunning portfolio website for a creative studio specializing in photography and design. The site features smooth animations, an intuitive gallery system, and a content management system that allows the studio to easily update their work and maintain their online presence.',
    category: 'Portfolio Design',
    imageUrl: '/roadtrip.jpg',
    heroImage: '/roadtrip.jpg',
    technologies: ['Next.js', 'Framer Motion', 'TypeScript', 'Sanity CMS', 'Vercel'],
